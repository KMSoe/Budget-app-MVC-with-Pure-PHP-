    ...
    <div class="side-inner">
        ...
        <div class="nav-menu">
            <ul>
                ...
                <!-- <li class="<?= htmlspecialchars($data["page"] === "notification" ? "active" : "") ?>"><a href="#"><i class="fas fa-bell me-2"></i>Notifications <span class="badge bg-danger rounded-pill ms-3">3</span></a></li> -->
